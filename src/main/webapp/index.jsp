							...
							<div class="products-tabs">
								...
								<div id="tab1" class="tab-pane active">
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<c:forEach items="${listproduct}" var="elements" begin="0" end="3">
										<!-- product -->
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4 col-xs-6">
						<div class="section-title">
							<h4 class="title">List Product 1</h4>
							<div class="section-nav">
					...
					<div class="col-md-4 col-xs-6">
						<div class="section-title">
							<h4 class="title">List Product 2</h4>
							<div class="section-nav">
					...
					<div class="col-md-4 col-xs-6">
						<div class="section-title">
							<h4 class="title">List Product 3</h4>
							<div class="section-nav">
...
<%--<								<p class="footer-links">Nguyen Trong Hieu</p>--%>
